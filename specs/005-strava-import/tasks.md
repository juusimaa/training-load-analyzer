...
- [ ] T035 [US1] CONFIRM — **deferred to Phase 4, blocked on T042**: assert FR-007's boundary — disconnecting leaves the **stored activities** untouched. Whether to discard them is the athlete's separate, explicit choice, not a side effect — file: `tests/TrainingLoadAnalyzer.Infrastructure.Tests/ConnectionTests.cs`
